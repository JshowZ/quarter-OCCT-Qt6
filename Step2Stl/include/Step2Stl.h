...
/**
 * @brief Configuration options for STEP to STL conversion
 */
typedef struct {
    /**
     * @brief Mesh tolerance in millimeters
     ...
     *        Called periodically during conversion with progress percentage (0-100)
